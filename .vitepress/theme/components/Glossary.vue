<template>
  <span
    class="underline decoration-dotted daisy-tooltip"
    :data-tip="glossary[title]"
  >
    {{ title }}
  </span>
</template>
...
const glossary = {
  MorningStar:
    'MorningStar is a cutting-edge, full-stack AI data platform designed specifically for the AI 2.0 era launched by Stardust.',
  Rosetta:
