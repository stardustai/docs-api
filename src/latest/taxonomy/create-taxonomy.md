...
| slotSpecification.name                                                    | false    | string       | Name for 2D/3D geometric shapes                                                                                                                                                                                                                                                                                                        |
...
| slotSpecification.minWidth/minHeight                                      | false    | number       | Min size (AQC) for relevant geometric shapes                                                                                                                                                                                                                                                                                           |
| slotSpecification.sizeCheckSwitch                                         | false    | boolean      | Dimensional verification flag (AQC)                                                                                                                                                                                                                                                                                                    |
| slotSpecification.topLeftMark/topRightMark/bottomLeftMark/bottomRightMark | false    | string       | vertex labels for shapes like 2D Box, 2D Polygon (if applicable)                                                                                                                                                                                                                                                                       |
| slotSpecification.restrictInsideCanvasBoundary                            | false    | boolean      | Flag indicating whether to annotate within the canvas                                                                                                                                                                                                                                                                                  |
| slotSpecification.minVertices/maxVertices                                 | false    | number       | Min/max vertices (AQC) for shapes like 3D box,3D Polygon,3D Polyline                                                                                                                                                                                                                                                                   |
| slotSpecification.presetSize.name                                         | false    | string       | The name of Preset size.Multiple sets can be configured                                                                                                                                                                                                                                                                                |
| slotSpecification.presetSize.geometry.width/height/depth                  | false    | number       | Depend on the configuration "slotSpecification.presetSize.name". The length, width and height need to be specified separately                                                                                                                                                                                                          |
| slotSpecification.maxPadding                                              | false    | number       | Border distance from point cloud (AQC) for 3D Box                                                                                                                                                                                                                                                                                      |
| slotSpecification.imageSourceMapping                                      | false    | string[]     | Child source mapping for 3D shapes.The value is child key(Unique identifier) (e.g., 3D Box, 3D Polygon, 3D Polyline, 3D Point)                                                                                                                                                                                                         |
| slotSpecification.mappingScope                                            | false    | string(Enum) | The way 3D maps the range to 2D.The Enum is outside, inside, both.                                                                                                                                                                                                                                                                     |
